...
{
    public class ElasticsearchKeywordSearchingTests : IClassFixture<ElasticsearchIndexFixture>
    {
        private ElasticsearchIndexFixture _fixture;

        public ElasticsearchKeywordSearchingTests(ElasticsearchIndexFixture fixture)
        {
            _fixture = fixture;
        }
        ...
        public async Task KeywordMapping_ProducesNoQueryTimeAnlaysis_ForMatchQuery(string matchText, string[] expectedTokens, string explanation)
        {
            ...
            var analyzeResult = await _fixture.ElasticClient.Indices.AnalyzeAsync(selector => selector
                .Analyzer("standard")
                .Index(testIndex.Name)
                .Text(matchText));
